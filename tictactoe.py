...
quit_button = ttk.Button(root, text="Quit", command=lambda: exit(0))
...
button_0.grid(column=0, row=0, ipady=20, ipadx=10)
...
button_1.grid(column=1, row=0, ipady=20, ipadx=10)
...
button_2.grid(column=2, row=0, ipady=20, ipadx=10)
...
button_3.grid(column=0, row=1, ipady=20, ipadx=10)
...
button_4.grid(column=1, row=1, ipady=20, ipadx=10)
...
button_5.grid(column=2, row=1, ipady=20, ipadx=10)
...
button_6.grid(column=0, row=2, ipady=20, ipadx=10)
...
button_7.grid(column=1, row=2, ipady=20, ipadx=10)
...
button_8.grid(column=2, row=2, ipady=20, ipadx=10)
